...
namespace MABEL_WOF\Core\Common\Managers
{
	...
	class License_Manager
	{
		...
		public function __construct( ) {
			...
			$this->name        = Config_Manager::$plugin_base;
		...
		public function init() {
			...
			add_action( 'in_plugin_update_message-' . $this->name, [ $this, 'in_plugin_update_message' ], 10, 2 );
		...
		private function api_request(  $action, $api_data = [] ) {
			...
			$request = wp_remote_post( $this->api_url, [ 'timeout' => 15, 'body' =>  array_merge($api_params, $api_data ) ] );
