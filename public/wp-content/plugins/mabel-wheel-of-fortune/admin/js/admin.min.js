...
var Core;!function(t){!function(e){var i=function(){function i(e){var n=t.Admin.Helpers.Context.getSlug();this.slug=n,this.parent=e,this.navlinks=this.parent.find(".mabel-nav-tab-wrapper a"),this.tabs=this.parent.find(".mabel-tab"),this.form=this.parent.find("#"+n+"-form"),this.settingsKey=t.Admin.Helpers.Context.getSettingsKey(),this.currentTab=this.parent.find(".mabel-nav-tab-active").data("tab"),this.sidebars=this.parent.find(".mabel-sidebar"),this.mainSidebar=this.sidebars.filter('[data-sidebar-for="main"]'),this.initColorPickers(),this.initDatePickers(),this.initRangeSliders(),this.initTabs(),this.initAccordions(),t.Admin.Helpers.Dependencies.initDependencies(this.settingsKey),this.toggleSidebars(),this.initChangeSettings(),this.initEvents(),i.initChoicePickers()}return i.loading=function(){this.isLoading?jQuery(".mabel-loading").hide():jQuery(".mabel-loading").show(),this.isLoading=!this.isLoading},i.stopLoading=function(){this.isLoading&&(jQuery(".mabel-loading").hide(),this.isLoading=!1)},i.showError=function(t,e){this.stopLoading(),jQuery(".mabel-error-popup-message").empty().append("<h1>"+t+"</h1><p>"+e+"</p>"),jQuery(".mabel-error-popup-wrapper").show()},i.hideError=function(){jQuery(".mabel-error-popup-wrapper").hide()},i.prototype.initDatePickers=function(){function t(t){if(t.indexOf("AM")>-1||t.indexOf("PM")>-1){var e=jQuery.trim(t).split(" ");return e[e.length-2]+" "+e[e.length-1]}var i=new Date,n=i.getHours(),a=i.getMinutes(),r="A'M'";return a<10&&(a="0"+a),12==n?r=" 'PM'":0==n?(n=12,r=" A'M'"):n>12?(n-=12,r=" P'M'"):r=" A'M'"," "+n+":"+a+r}jQuery(".mabel-date-picker").each(function(e,i){var n=jQuery(i),a=n.data("options")||{};n.datepicker(jQuery.extend(a,{dateFormat:"M dd, yy"+t(n.val()),onSelect:function(t){i.dispatchEvent(new Event("input"))}}))})},i.initChoicePickers=function(){jQuery(".mabel-mc-wrapper").each(function(e,i){new t.Admin.Components.ChoicePicker(jQuery(i))})},i.prototype.initRangeSliders=function(){jQuery('input[type="range"]').each(function(t,e){var i=jQuery(e);i.rangeslider({polyfill:!1,onSlideEnd:function(t,e){i.val(e)}})})},i.prototype.initAccordions=function(){var t=this.parent.find(".mabel-accordion");this.parent.find(".mabel-accordion button.mabel-accordion-btn");t.each(function(t,e){var i=jQuery(e);i.find("button.mabel-accordion-btn").on("click",function(t){t.preventDefault(),jQuery(t.currentTarget).next().toggleClass("mabel-is-expanded").toggleClass("mabel-is-collapsed"),i.toggleClass("active")})})},i.prototype.initEvents=function(){var e=this,i=window.tb_remove;window.tb_remove=function(){i(),t.Admin.Dispatcher.publish("modal:closed")},t.Admin.Dispatcher.subscribe("settings:save",function(){e.saveSettings()})},i.setColorPickerColor=function(t,e){jQuery(".color-picker[name="+t+"]").wpColorPicker("color",e)},i.prototype.initColorPickers=function(){var e=this;this.parent.find(".color-picker").each(function(i,n){function a(i,n){var a=jQuery(i.target),r=a.attr("name");t.Admin.Dispatcher.publish("color:changed",{color:n.color.toString(),id:r}),a.parents(".skip-save").length||(e.saveSettings(),t.Admin.Dispatcher.publish("settings:changed",t.Admin.Helpers.Context.getSettings()))}var r=jQuery(n);if(r.wpColorPicker({defaultColor:r.val(),change:function(t,e){a(t,e)},clear:function(){a({target:r[0]},{color:""})}}),r.val().length){var s={target:n},o={color:r.val()};setTimeout(function(){a(s,o)},30)}})},i.prototype.initChangeSettings=function(){var i=this;this.form.find(".mabel-form-element").on("change",function(n){var a=jQuery(n.currentTarget);a.hasClass("skip-save")||a.parents(".skip-save").length||(e.Dispatcher.publish("settings:changed",t.Admin.Helpers.Context.getSettings()),i.saveSettings())}),this.form.find('input[type="number"]').not(".skip-save").each(function(t,e){var n=jQuery(e);if(!n.parents(".skip-save").length){var a=0;n.on("change keyup keydown input",function(){clearTimeout(a),a=setTimeout(function(){i.saveSettings()},600)})}})},i.prototype.saveSettings=function(){var e=this;this.parent.find(".all-settings-saved").hide(),this.parent.find(".saving-settings").show();var i=this.form.serializeArray();jQuery.post("options.php",i).done(function(){e.parent.find(".all-settings-saved").show(),e.parent.find(".saving-settings").hide(),t.Admin.Dispatcher.publish("settings:saved",t.Admin.Helpers.Context.getSettings())})},i.prototype.initTabs=function(){var e=this,i=this.parent.find(".mabel-nav-tab-wrapper a");this.parent.find(".mabel-tab");i.on("click",function(t){t.preventDefault(),e.setTab(jQuery(t.currentTarget).data("tab"))}),t.Admin.Dispatcher.subscribe("tab:activate",function(t){e.setTab(t)})},i.prototype.setTab=function(e){var i=this.parent.find('[data-tab="'+e+'"]');this.navlinks.removeClass("mabel-nav-tab-active"),i.addClass("mabel-nav-tab-active"),this.tabs.hide(),this.parent.find(".tab-"+e).show(),t.Admin.Dispatcher.publish("tab:changed",e),this.currentTab=e,this.toggleSidebars()},i.prototype.toggleSidebars=function(){this.sidebars.hide();var t=this.sidebars.filter('[data-sidebar-for="'+this.currentTab+'"]');t.length&&!t.is(":empty")?t.show():this.mainSidebar.show()},i}();e.Main=i}(t.Admin||(t.Admin={}))}(Core||(Core={}));
...
var Core;!function(e){!function(e){!function(t){var i=function(){function t(t,i,s){void 0===i&&(i=null),void 0===s&&(s=!0);var l=this;this.$input=t.find("input[type=text]"),this.$parent=t,this.$hidden=t.find("input[type=hidden]"),this.values=t.data("values")?t.data("values"):[],this.onChange=i,this.multiselect=s,this.$input.on("keydown",function(){l.$input.css("width",50+8*l.$input.val().length)}),t.on("click",function(e){e.preventDefault(),l.$input.focus()}),t.mabelAutocomplete(e.Helpers.Context.getAdminAjaxUrl()+"?action="+t.data("action"),{multiple:s,multipleSep:";",delay:350,onSelect:function(e){l.values.push(e),l.$input.val(""),l.setHiddenValue(),l.addElementsToUi(e),"function"==typeof i&&i(l.$hidden.val())}})}return t.prototype.setValues=function(e){var t=this;this.values=e,this.setHiddenValue(),this.values.forEach(function(e){t.addElementsToUi(e)}),!this.multiselect&&e.length&&this.$input.css("visibility","hidden")},t.prototype.clear=function(){this.values=[],this.$hidden.val(""),this.$parent.find(".mabel-autoselect-chosen").remove(),this.$input.css("visibility","visible")},t.prototype.addElementsToUi=function(e){var t=this;jQuery('<span class="mabel-autoselect-chosen"></span>').html(e.title).on("click",function(i){i.preventDefault(),jQuery(i.currentTarget).remove(),t.values.forEach(function(i,s){i.title===e.title&&t.values.splice(s,1)}),t.setHiddenValue(),t.$input.css("visibility","visible"),"function"==typeof t.onChange&&t.onChange(t.$hidden.val())}).insertBefore(this.$input)},t.prototype.setHiddenValue=function(){var e=[];this.values.forEach(function(t){e.push(t.id)}),this.$hidden.val(e.join(","))},t}();t.MultiAutoComplete=i}(e.Components||(e.Components={}))}(e.Admin||(e.Admin={}))}(Core||(Core={})),function(e){e.mabelautocomplete=function(t,i){function s(){var e=m.offset();v.css({top:e.top+m.outerHeight()+"px",left:e.left+"px"})}function l(e){if(/27$|38$|40$/.test(e.keyCode)&&v.is(":visible")||/^13$|^9$/.test(e.keyCode)&&r())switch(e.preventDefault&&e.preventDefault(),e.stopPropagation&&e.stopPropagation(),e.cancelBubble=!0,e.returnValue=!1,e.keyCode){case 38:p();break;case 40:h();break;case 9:case 13:d();break;case 27:v.hide()}else m.val().length!=b&&(C&&clearTimeout(C),C=setTimeout(n,i.delay),b=m.val().length)}function n(){var t,s,l=e.trim(m.val());if(i.multiple&&-1!=(t=l.lastIndexOf(i.multipleSep))&&(l=e.trim(l.substr(t+i.multipleSep.length))),l.length>=i.minchars){var n=a(l);n?u(n.items):(f.addClass("mabel-autocomplete-loading"),e.getJSON(i.source,{q:l},function(e){v.hide(),s=[];for(var t=0;t<e.length;t++)s.push(c(e[t],l));u(s),o(l,s),f.removeClass("mabel-autocomplete-loading")}))}else v.hide()}function a(e){var t;for(t=0;t<y.length;t++)if(y[t].q==e)return y.unshift(y.splice(t,1)[0]),y[0];return!1}function o(e,t){y.push({q:e,items:t})}function u(t){var l,n="";if(t){if(!t.length)return void v.hide();for(s(),l=0;l<t.length;l++)n+="<li>"+t[l]+"</li>";v.html(n).show(),v.children("li").mouseover(function(){v.children("li").removeClass(i.selectClass),e(this).addClass(i.selectClass)}).click(function(e){e.preventDefault(),e.stopPropagation(),d()})}}function c(e,t){return'<span data-id="'+e.id+'">'+e.title+"</span>"}function r(){var e;return!!v.is(":visible")&&(e=v.children("li."+i.selectClass),e.length||(e=!1),e)}function d(){var e=r();if(e){var t=e.text(),s=e.find("span").first().data("id");i.onSelect&&i.onSelect({title:t,id:s})}i.multiple?m.css("visibility","visible"):m.css("visibility","hidden")}function h(){var e=r();e?e.removeClass(i.selectClass).next().addClass(i.selectClass):v.children("li:first-child").addClass(i.selectClass)}function p(){var e=r();e?e.removeClass(i.selectClass).prev().addClass(i.selectClass):v.children("li:last-child").addClass(i.selectClass)}var f,m,v,C,b,y;f=e(t),m=f.find("input[type=text]").attr("autocomplete","off"),v=e('<ul class="mabel-autocomplete-results"/>'),C=!1,b=0,y=[],v.addClass(i.resultsClass).appendTo("body"),s(),e(window).on("load",s).on("resize",s),m.blur(function(){setTimeout(function(){v.hide()},200)}),m.keydown(l)},e.fn.mabelAutocomplete=function(t,i){if(t)return i=i||{},i.multiple=i.multiple||!1,i.multipleSep=i.multipleSep||",",i.source=t,i.delay=i.delay||100,i.resultsClass=i.resultsClass||"ac_results",i.selectClass=i.selectClass||"ac_over",i.matchClass=i.matchClass||"ac_match",i.minchars=i.minchars||2,i.delimiter=i.delimiter||"\n",i.onSelect=i.onSelect||!1,i.maxCacheSize=i.maxCacheSize||65536,this.each(function(){new e.mabelautocomplete(this,i)}),this}}(jQuery);
...
var WOFAdmin;!function(e){!function(e){var i=function(){function e(){this.usage="popup",this.theme="blue",this.amount_of_slices=12,this.slices=[],this.active="1",this.winning_chance=70,this.limit_prizes=!1,this.plays=0,this.bgpattern="hearts",this.spinspeed="2",this.spintime="7",this.title="Get your chance to <em>win a prize</em>!",this.explainer="Enter your email address and spin the wheel. This is your chance to win amazing discounts!",this.disclaimer="Our in-house rules:<ul><li>One game per user</li><li>Cheaters will be disqualified.</li></ul>",this.email_placeholder="Your email",this.button_text="Try your luck",this.button_done="I'm done playing",this.close_text="I don't feel lucky",this.losing_title="Uh oh! Looks like you lost",this.losing_text="We're sorry, the wheel of fortune has let you down. Better luck next time!",this.winning_title="Hurray! You've hit {x}. Lucky you!",this.winning_text_coupon="Nicely done! You can use the coupon code below to claim your prize:",this.winning_text_gift="Nicely done! We have added your free gift to your cart!",this.winning_text_link="Nicely done! here's the link to your free product:",this.winning_text_texthtml="Nicely done! here are your instructions:",this.button_again="Try again",this.ip_used_error="You've already played.",this.games_left_text="You have {x} spins left",this.email_already_used="This email address is already used",this.user_inclusion="0",this.appeartype="exit",this.appeardelay=5,this.appearscroll=60,this.occurance="session",this.occurancedelay=14,this.retry_occurance="session",this.occurance_after_delay=5,this.play_after_delay=1,this.play_after="page",this.hide_mobile=!0,this.hide_desktop=!1,this.esc_key=!1,this.hide_tablet=!1,this.fields=[],this.coupon_settings=[],this.coupon_bar=!1,this.woo_auto_apply=!1,this.bar_text="Your coupon code {code} is valid for {countdown}",this.bar_days="d",this.bar_hours="h",this.bar_minutes="m",this.bar_seconds="s",this.widget="pullout"}return e}();e.Wheel=i}(e.Models||(e.Models={}))}(WOFAdmin||(WOFAdmin={}));
...
var WOFAdmin;!function(e){!function(t){var i=function(){function t(){this.$wheelsList=jQuery(".wof-wheels-list"),this.getWheelsList(),this.initEditWheel(),this.initDeleteWheel(),this.initDuplicateWheel(),this.initToggleActivation(),this.initStats(),this.initViewOptinsAndPlays(),this.initExport(),this.initDeleteLogs()}return t.prototype.initToggleActivation=function(){this.$wheelsList.on("click",".wof-toggle-active",function(t){var i=jQuery(t.currentTarget);e.Api.Wheels.toggleActivation(i.data("wheel"),i.is(":checked")?1:0)})},t.prototype.getWheelsList=function(){var t=this;e.Api.Wheels.getStatistics().then(function(e){t.statistics=e}),e.Api.Wheels.getWheels().then(function(e){if(t.wheels=e,0===t.wheels.length)jQuery(".wof-no-results").show();else{jQuery(".wof-no-results").hide();var i=window.doT.template(jQuery("#tpl-wof-wheels-list").html());t.$wheelsList.html(i({wheels:e}))}jQuery(document).trigger("wof:after_get_wheels",[e])})},t.prototype.initDuplicateWheel=function(){var t=!1;this.$wheelsList.on("click",".wof-duplicate-wheel",function(i){if(i.preventDefault(),!t){t=!0;var n=jQuery(i.currentTarget);n.css("opacity",.5),e.Api.Wheels.getWheel(n.data("wheel")).then(function(i){i.id=null,e.Api.Wheels.addWheel(i).then(function(){Core.Admin.Dispatcher.publish("wof-wheel:created"),t=!1,n.css("opacity",1)})})}})},t.prototype.initEditWheel=function(){this.$wheelsList.on("click",".wof-edit-wheel",function(t){t.preventDefault(),Core.Admin.Main.loading();var i=jQuery(t.currentTarget);e.Api.Wheels.getWheel(i.data("wheel")).then(function(e){Core.Admin.Dispatcher.publish("wof-wheel:edit",e)})})},t.prototype.initDeleteWheel=function(){this.$wheelsList.on("click",".wof-delete-wheel",function(t){if(t.preventDefault(),confirm("Are you sure you want to delete this wheel?")){var i=jQuery(t.currentTarget);e.Api.Wheels.deleteWheel(i.data("wheel")).then(function(){i.closest(".image-tile").hide()})}})},t.prototype.initExport=function(){jQuery(".wof-btn-export-csv").on("click",function(e){e.preventDefault(),window.location.href="?page=mabel-wheel-of-fortune&wof-export-csv&wheel_id="+jQuery(e.currentTarget).data("wheel")})},t.prototype.initDeleteLogs=function(){jQuery(".wof-btn-delete-logs").on("click",function(t){var i=jQuery(t.currentTarget);i.html("Deleting..."),t.preventDefault(),e.Api.Log.deleteOptins(jQuery(t.currentTarget).data("wheel")).then(function(){i.html("Deleted!"),jQuery("table.wof-optins-log tbody").html("")})})},t.prototype.initViewOptinsAndPlays=function(){var t=this;this.$wheelsList.on("click",".wof-view-optins",function(i){i.preventDefault(),Core.Admin.Main.loading();var n=e.helpers.Collections.findBy(t.wheels,"id",jQuery(i.currentTarget).data("wheel"));if(null!==n){jQuery(".wof-btn-export-csv").data("wheel",n.id),jQuery(".wof-btn-delete-logs").data("wheel",n.id);var l=jQuery("table.wof-optins-log"),o=l.find("tbody");o.empty(),e.Api.Log.getLastOptins(n.id).then(function(e){for(var t=0;t<e.length;t++){var i=e[t],n=jQuery("<tr>");n.append("<td>"+i.date+"</td>"),n.append("<td>"+i.type+"</td>"),n.append("<td>"+i.log+"</td>"),o.append(n)}window.tb_show("Last 30 logs","#TB_inline?width=800&height=550&inlineId=wof-optins-log-modal"),Core.Admin.Main.loading()})}})},t.prototype.initStats=function(){var t=this;this.$wheelsList.on("click",".wof-get-statistics",function(i){var n=jQuery(i.currentTarget),l=e.helpers.Collections.findBy(t.wheels,"id",n.data("wheel")),o=t.getStatsById(l.id),s=window.doT.template(jQuery("#tpl-wof-statistics-modal").html());jQuery("#wof-statistics-modal").html(s({haslimits:l.limit_prizes,stats:o})),window.tb_show("Wheels of Fortune statistics","#TB_inline?width=550&height=400&inlineId=wof-statistics-modal"),l.limit_prizes&&e.Api.Wheels.getPrizeLimits(l.id).then(function(t){var i=[];l.slices.forEach(function(n){var l=e.helpers.Collections.findBy(t,"segment",""+n.id),o=l?l.total:0;i.push({slice:n.id,haslimit:"0"!=n.type&&n.limit>-1,limit:n.limit,won:o,left:n.limit-o})});var n=window.doT.template(jQuery("#tpl-wof-prize-limits").html());jQuery("#TB_window .wof-wheel-limits").html(n({l:i}))})})},t.prototype.getStatsById=function(e){for(var t=0;t<this.statistics.length;t++)if(this.statistics[t].wheel_id===e)return this.statistics[t];return null},t}();t.WheelsListCtrl=i}(e.Controllers||(e.Controllers={}))}(WOFAdmin||(WOFAdmin={}));
...
var WOFAdmin;!function(t){!function(e){var r=function(){function e(){}return e.getListFields=function(r,i){return void 0===i&&(i=null),jQuery.getJSON(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.get_list_fields,provider:r,list:i}).fail(function(){Core.Admin.Main.showError("Something went wrong :(","We couldn't fetch form fields for your "+t.helpers.Strings.providerToText(r)+" list. Please check your API credentials in the 'Integrations' tab.<br/><br/>Not the issue? <a href='https://www.studiowombat.com/request-support' target='_blank'>Contact us</a> for support.")}).then(function(t){return t})},e.getActiveProvidersLists=function(){return jQuery.getJSON(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.get_active_provider_lists}).fail(function(){Core.Admin.Main.showError("Something went wrong :(","One of your wheels is connected to a tool we can't seem to connect to. Please verify your API settings are correct in the 'Integrations' tab.<br/><br/>Not the issue? <a href='https://www.studiowombat.com/request-support' target='_blank'>Contact us</a> for support.")}).then(function(t){return t})},e.getProviderLists=function(t){return jQuery.getJSON(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.get_provider_lists,provider:t}).fail(function(){Core.Admin.Main.showError("Something went wrong :(","We couldn't fetch the lists for <b>"+t+"</b>. Please verify your settings for "+t+" are correct. You can find them in the 'Integrations' tab.")}).then(function(t){return t})},e.getMailchimpGroups=function(t){return jQuery.getJSON(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.get_mailchimp_groups,id:t}).then(function(t){return t})},e.get_provider_lists="mb-wof-get-provider-lists",e.get_active_provider_lists="mb-wof-get-active-provider-lists",e.get_list_fields="mb-wof-get-list-fields",e.get_mailchimp_groups="mb-wof-get-mailchimp-groups",e}();e.Mail=r}(t.Api||(t.Api={}))}(WOFAdmin||(WOFAdmin={}));
var WOFAdmin;!function(e){!function(e){var t=function(){function e(){}return e.toggleActivation=function(t,n){return jQuery.post(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.toggle_active_toggle,id:t,toggle:n}).then(function(e){return e})},e.updateWheel=function(t,n){return jQuery.post(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.update_wheel_action,id:t,options:JSON.stringify(this.removeEmpties(n))}).then(function(e){return e})},e.addWheel=function(t){return jQuery.post(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.add_wheel_action,options:JSON.stringify(this.removeEmpties(t))}).then(function(e){return e})},e.deleteWheel=function(t){return jQuery.get(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.delete_wheel_action,id:t}).then(function(e){return e})},e.getWheels=function(){return jQuery.getJSON(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.get_wheels_action}).then(function(e){return e})},e.getWheel=function(t){return jQuery.getJSON(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.get_wheel_action,id:t}).then(function(e){return e})},e.getPrizeLimits=function(t){return jQuery.getJSON(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.get_prize_limits_action,id:t}).then(function(e){return e})},e.getStatistics=function(){return jQuery.getJSON(Core.Admin.Helpers.Context.getAdminAjaxUrl(),{action:e.get_statistics_action}).then(function(e){return e})},e.removeEmpties=function(e){var t={};return e.active=null,Object.keys(e).forEach(function(n){void 0!==e[n]&&null!==e[n]&&(t[n]=e[n])}),t},e.get_wheel_action="mb-wof-get-wheel",e.get_wheels_action="mb-wof-get-wheels",e.delete_wheel_action="mb-wof-delete-wheel",e.add_wheel_action="mb-wof-add-wheel",e.update_wheel_action="mb-wof-update-wheel",e.toggle_active_toggle="mb-wof-toggle-activation",e.get_statistics_action="mb-wof-get-statistics",e.get_prize_limits_action="mb-wof-get-limits",e}();e.Wheels=t}(e.Api||(e.Api={}))}(WOFAdmin||(WOFAdmin={}));
...
var WOFAdmin;!function(n){!function(n){var r=function(){function r(){}return r.nextAvailableName=function(r,t){var e=n.Collections.findAllBy(t,"type",r),i=0;return e.forEach(function(n,r){var t=n.id.replace(/^\D+/g,"");t&&parseInt(t)>i&&(i=parseInt(t))}),r+"_"+(i+1).toString()},r.findAllBy=function(n,r,t){var e=[];return n&&n.length?(n.forEach(function(n,i){n[r]==t&&e.push(n)}),e):e},r.findBy=function(n,r,t){if(!n||!n.length)return null;for(var e=0;e<n.length;e++)if(n[e][r]==t)return n[e];return null},r}();n.Collections=r}(n.helpers||(n.helpers={}))}(WOFAdmin||(WOFAdmin={}));
