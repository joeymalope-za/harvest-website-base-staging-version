...
display: inline; 
  ...
  jQuery(document).ready(function($){
   ...
   // if(unsaved) return '<?php esc_html_e('Changes you made may not be saved.','woo-zoho'); ?>';
});
          // Tooltips
  var tiptip_args = {
  'attribute' : 'data-tip',
  ...
  $(this).text('<?php esc_html_e('Show Key','woo-zoho') ?>');  
  $(this).removeClass('vx_hidden');
  key.attr('type','password');  
  }else{
  $(this).text('<?php esc_html_e('Hide Key','woo-zoho') ?>');  
