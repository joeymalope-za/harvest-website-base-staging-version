...
class GW_Minimum_Characters {
	...
	public function validate_character_count( $result, $value, $form, $field ) {
		...
		// Special condition: If it's form 26 and the field is blank, allow it (no password change).
    if( $this->_args['form_id'] == 26 && $value == '' ) {
        return $result;
    }
...
new GW_Minimum_Characters( array(
	...
	'max_chars'              => 30,
	// translators: placeholder is a number
	'min_validation_message' => __( 'Oops! You need to enter at least 6 characters.' ),
	// translators: placeholder is a number
	'max_validation_message' => __( 'Oops! You can only enter 30 characters.' ),
) );
