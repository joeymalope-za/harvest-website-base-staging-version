...
if ( function_exists( 'wpm_fs' ) ) {
    ...
    class WCPM
    {
        ...
        {
            if ( Environment::is_woocommerce_active() && (Shop::pmw_is_order_received_page() || is_cart() || is_checkout()) ) {
                return;
            }
            add_filter(
                'script_loader_tag',
