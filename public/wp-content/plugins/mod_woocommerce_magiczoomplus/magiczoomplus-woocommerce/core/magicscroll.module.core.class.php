...
if(!defined('MagicScrollModuleCoreClassLoaded')) {
    ...
    class MagicScrollModuleCoreClass {
        ...
        function getHeadersTemplate($jsPath = '', $cssPath = null, $linkModuleCss = true) {
            ...
            $headers = array();
            // add module version
            $headers[] = '<!-- Magic Zoom Plus WooCommerce module version v6.9.3 [v1.6.93:v5.3.7] -->';
        ...
        function loadDefaults() {
            $params = array(
				...
				"page-status"=>array("id"=>"page-status","group"=>"General","order"=>"5","default"=>"No","label"=>"Enable Magic Zoom Plus","type"=>"array","subType"=>"select","values"=>array("Yes","No"),"scope"=>"module"),
