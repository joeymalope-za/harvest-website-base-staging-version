...
if(!function_exists('WooCommerce_MagicZoomPlus_remove_placeholder')){
    function WooCommerce_MagicZoomPlus_remove_placeholder($images){
        $arr_copy = $images;
...
if (!isset($GLOBALS['magictoolbox']['WooCommerce_MagicZoomPlus_product_loaded'])) {
...
<div class="images">
	...
	<?php
        ...
        if ( $flag ) {                 
                        ...
                        $thumbs = WooCommerce_MagicZoomPlus_get_prepared_selectors($pid, $useWpImages);
                        $thumbs = WooCommerce_MagicZoomPlus_remove_placeholder($thumbs);
                        ...
                        if ($useWpImages) {
                            ...
                            $img_result = $plugin->getMainTemplate(compact('img','thumb','id','title','alt','description','additionalDescription','link'));
                        ...
                        echo $invisImg.$html;
                        $GLOBALS['magictoolbox']['WooCommerce_MagicZoomPlus_product_loaded'] = true;
