...
if(count($thumbs) > 1) {
        ...
        if(!empty($magicscroll) && !is_numeric(self::$options->getValue('height'))) {
            ...
            <script type="text/javascript">
                ...
                mzOptions.onUpdate = function() {
                    MagicScroll.resize(\'MagicToolboxSelectors'.$pid.'\');
                };
            </script>';
            ?>
            <?php
    ...
    ?>
    <div class="MagicToolboxSelectorsContainer" style="display:none; flex-basis: <?php echo $selectorMaxWidth ?>px; width: <?php echo $selectorMaxWidth ?>px;">
