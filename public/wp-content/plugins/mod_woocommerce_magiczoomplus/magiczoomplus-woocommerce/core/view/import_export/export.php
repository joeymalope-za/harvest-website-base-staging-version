<?php
    function WooCommerce_MagicZoomPlus_wp_export($core_sett, $constructor_sett, $set="all") {
        ...
        $license = magictoolbox_WooCommerce_MagicZoomPlus_get_data_from_db();
        if ($license) {
        ...
        $scroll_license = magictoolbox_WooCommerce_MagicZoomPlus_get_data_from_db('WooCommerce_MagicZoomPlus_magicscroll');
        if ($scroll_license) {
        ...
        $filename = $sitename . 'woocommerce.magiczoomplus.' . date( 'Y-m-d' ) . '.xml';
