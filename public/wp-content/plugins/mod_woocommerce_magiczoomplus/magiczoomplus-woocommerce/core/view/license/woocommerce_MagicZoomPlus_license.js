(function ($) {
    ...
    function CheckLicense(node) {
        var license,
            ...
            toolLower = 'magiczoomplus',
            toolName = 'Magic Zoom Plus',
        ...
        function click(e) {
            ...
            $.post(magictoolbox_WooCommerce_MagicZoomPlus_admin_modal_object.ajax, {
                action: "magictoolbox_WooCommerce_MagicZoomPlus_set_license",
                nonce: magictoolbox_WooCommerce_MagicZoomPlus_admin_modal_object.nonce,
                key: license,
