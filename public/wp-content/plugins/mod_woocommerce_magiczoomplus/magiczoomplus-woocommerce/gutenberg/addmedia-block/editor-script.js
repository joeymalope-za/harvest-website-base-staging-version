(function(wpElement, wpBlocks, wpComponents, wpEditor, wpi18n){
    ...
    const store = registerStore( 'woocommerce-magiczoomplus/addmedia-block', {
        ...
        resolvers: {
                * receiveShortCodes( state ) {
                        const shortcodes = yield actions.receiveShortCodes( '/magiczoomplus/get-shortcodes' );
    ...
    registerBlockType( 'woocommerce-magiczoomplus/addmedia-block', {
        title: __('MagicZoomPlus'),
        description: __(''),
        icon: 'search',
        category: 'common',
        attributes: {
        ...
        edit:  withSelect( ( select ) => {
               return {
                    shortcodes: select('woocommerce-magiczoomplus/addmedia-block').receiveShortCodes(),
                };
                } )
        ...
        save: function( props ){
            ...
            return el('div', {
                        ...
                        'data-text': props.attributes.shText,
                                ...
                                __('[magiczoomplus id="'+props.attributes.shId+'"]'),
                        ]
                );
